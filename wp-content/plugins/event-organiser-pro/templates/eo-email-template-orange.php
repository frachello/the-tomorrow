<?php
/**
 * Event Organiser Email Template: Orange
 *
...
<div style="background: #f0f0f0; padding: 8px 10px;">
	<div style="background: #d54e21; width: 550px;  border: 1px solid #ccc; margin: 0 auto;border-radius:5px;">
		...
		<div  id="eo-email-footer" style="background: #d54e21; height:50px;position:relative;">
