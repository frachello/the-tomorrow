...
class EO_Extension_Pro extends EO_Extension{

	public $slug 		= 'event-organiser-pro/event-organiser-pro.php';
	public $public_url 	= 'http://wp-event-organiser.com/pricing';
	public $label 		= 'Pro';
	public $id 			= 'eventorganiser_pro';
